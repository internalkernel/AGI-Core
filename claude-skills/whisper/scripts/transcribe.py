...
def main():
    ...
    if args.task == "translate" and args.model == "turbo":
        print("Error: The 'turbo' model does not support translation. Use 'medium' or 'large' instead.", file=sys.stderr)
        sys.exit(1)
    ...
    try:
        ...
        print("Error: OpenAI Whisper is not installed. Install with: pip install openai-whisper", file=sys.stderr)
        sys.exit(1)
