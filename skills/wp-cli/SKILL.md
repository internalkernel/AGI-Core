...
```bash
$WPCLI backup-db prod --output /tmp/backup.sql
$WPCLI backup-db prod                     # Dumps to stdout
```
...
- **With workspace:** `$OPENCLAW_WORKSPACE/cache/wp-cli/`
- **Fallback:** `~/.openclaw/skills/wp-cli/data/`
