        ...
        async init(api) {
            ...
            api.registerProvider({
                ...
                async chatCompletion(request, context) {
                    ...
                    console.log(`🎯 [${decision.tier}] ${decision.recommendedModel} ` +
                    ...
                    try {
                        const response = await routeToProvider(modelConfig, request, decision);
                        ...
                        if (decision.tier === "REASONING" && decision.fallbackModel) {
                            ...
                            const fallbackResponse = await routeToProvider(fallbackConfig, request, fallbackDecision);
...
async function routeToProvider(modelConfig, request, decision) {
